...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/audio/audio_platform_info_qrd.PD1963.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_platform_info_qrd.PD1963.xml \
    $(LOCAL_PATH)/configs/audio/audio_platform_info_qrd.PD1968F_EX.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_platform_info_qrd.PD1968F_EX.xml \
    $(LOCAL_PATH)/configs/audio/audio_platform_info_qrd.TD1907.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_platform_info_qrd.TD1907.xml \
    $(LOCAL_PATH)/configs/audio/audio_platform_info_qrd.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_platform_info_qrd.xml \
    $(LOCAL_PATH)/configs/audio/audio_policy_configuration.original.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_configuration.original.xml \
    $(LOCAL_PATH)/configs/audio/audio_policy_configuration.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_configuration.xml \
    $(LOCAL_PATH)/configs/audio/audio_policy_configuration_for_vts.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_configuration_for_vts.xml \
    ...
    $(LOCAL_PATH)/configs/audio/mixer_paths_qrd.PD1963.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_qrd.PD1963.xml \
    $(LOCAL_PATH)/configs/audio/mixer_paths_qrd.PD1968F_EX.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_qrd.PD1968F_EX.xml \
    $(LOCAL_PATH)/configs/audio/mixer_paths_qrd.TD1907.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_qrd.TD1907.xml \
    ...
    $(LOCAL_PATH)/configs/audio/sound_trigger_mixer_paths_qrd.PD1963.xml:$(TARGET_COPY_OUT_VENDOR)/etc/sound_trigger_mixer_paths_qrd.PD1963.xml \
    $(LOCAL_PATH)/configs/audio/sound_trigger_mixer_paths_qrd.PD1968F_EX.xml:$(TARGET_COPY_OUT_VENDOR)/etc/sound_trigger_mixer_paths_qrd.PD1968F_EX.xml \
    $(LOCAL_PATH)/configs/audio/sound_trigger_mixer_paths_qrd.TD1907.xml:$(TARGET_COPY_OUT_VENDOR)/etc/sound_trigger_mixer_paths_qrd.TD1907.xml \
    $(LOCAL_PATH)/configs/audio/sound_trigger_mixer_paths_qrd.xml:$(TARGET_COPY_OUT_VENDOR)/etc/sound_trigger_mixer_paths_qrd.xml \
    $(LOCAL_PATH)/configs/audio/sound_trigger_platform_info.PD1963.xml:$(TARGET_COPY_OUT_VENDOR)/etc/sound_trigger_platform_info.PD1963.xml \
    $(LOCAL_PATH)/configs/audio/sound_trigger_platform_info.PD1968F_EX.xml:$(TARGET_COPY_OUT_VENDOR)/etc/sound_trigger_platform_info.PD1968F_EX.xml \
    $(LOCAL_PATH)/configs/audio/sound_trigger_platform_info.TD1907.xml:$(TARGET_COPY_OUT_VENDOR)/etc/sound_trigger_platform_info.TD1907.xml \
...
# Inherit vendor
$(call inherit-product, vendor/vivo/PD1963/PD1963-vendor.mk)